...
class ProjectsList extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      priceFeed: "1 $",
      marketCap: "10000000 $",
      allocationMethod: "Marketcap Weighted",
      allocationGoal: "10 %",
      allocationCurrent:"0 %",
          ...
          <Col>
              <div className="table-responsive">
                <Table className="project-list-table table-nowrap align-middle table-borderless">
                  <thead>
                    <tr>
                      <th scope="col" style={{ width: "100px" }}> Asset
                      </th>
                      <th scope="col"></th>
                      <th scope="col">Price</th>
                      <th scope="col">Market Cap</th>
                      <th scope="col">Allocation Method</th>
                      <th scope="col">Goal Allocation</th>
                  ...
                  <tbody>
                    {map(projects, (project, index) => (
                      <tr key={index}>
                        ...
                        <td>{this.state.priceFeed}</td>
                        <td>{this.state.marketCap}</td>                        
                        <td>{this.state.allocationMethod}</td>
                        <td>{this.state.allocationGoal}</td>
                        <td>{this.state.allocationCurrent}</td>
                        <td>
                          <Badge
                            color={project.color}
                        ...
                        <td>
                          <button className="mdi mdi-trash-can text-danger font-size-16"
                            onClick={() =>
