...
import logo from "../../assets/images/zendex_logo_light_text_transparent.svg";
import lightlogo from "../../assets/images/zendex_logo_dark_text.svg";

// Style
import "../../assets/scss/custom/structure/_custom.scss"
              ...
              <Col md={8} lg={6} xl={5}>
                <Card className="overflow-hidden">
                  <div className="">
                    ...
                    <div className="">
                      <Link to="/" className="">
                        <div className="avatar-md margin-left-20 margin-bottom-75">
                          <span className="">
                            <img
                              src={logo}
                              alt=""
